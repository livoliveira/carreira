...
class Candidatura{
   ...
   private $disponiblidade;
	 ...
	 * @return mixed
	 */
	public function getBenificios() {
		return $this->benificios;
	}
	
	/**
	 * @param mixed $benificios 
	 * @return self
	 */
	public function setBenificios($benificios): self {
	 ...
	 * @return mixed
	 */
	public function getDisponiblidade() {
		return $this->disponiblidade;
	}
	
	/**
	 * @param mixed $disponiblidade 
	 * @return self
	 */
	public function setDisponiblidade($disponiblidade): self {
